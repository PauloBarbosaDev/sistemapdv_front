      ...
      <section>
        <div className="flex flex-col p-4 gap-9">
          ...
          <p className="text-paragraph1 w-[41.208rem] text-darkBlue">
            Simplifique suas operações de checkout, controle seu estoque em
            tempo real e impulsione o crescimento do seu negócio com nosso
            sistema PDV intuitivo e confiável.
          </p>
        </div>
