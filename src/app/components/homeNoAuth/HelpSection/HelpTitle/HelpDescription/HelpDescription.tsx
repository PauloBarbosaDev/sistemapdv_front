const HelpDescription = () => {
  return (
    <p className="text-xl max-w-md sm:max-w-xl sm:w-[37.25rem] text-darkBlue leading-6 sm:leading-7">
      ...
      necessidades, garantindo uma experiência de suporte de alta qualidade a
